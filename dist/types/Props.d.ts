...
import { AnnotatedLine, AnnotationStyle, Line, RenderType, WordPart } from '../types/AnnotatedText';
...
export interface RecursiveAnnotatedTokenPartTextProps {
    ...
    annotations?: Annotation[];
    annotationClassHandler?: (annotation: Annotation, start: number, end: number, allowCreate: boolean) => string[];
