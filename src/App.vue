...
import { AnnotatedText, Annotation, AnnotationTarget, Line, Paragraph } from "./VueComponentAnnotatedText";
...
const textToLines = (text: string): Line[] => {
            ...
            for(let i = 0; i < lines.length; i++) {
                ...
                gutter = lines[i].match(regLineNumber) ? lines[i].match(regLineNumber)[0] : ''
                lineObjects[i] = {
                    gutter: gutter,
