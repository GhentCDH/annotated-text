...
| double-click             | Emitted when an annotation is double-clicked, and not other action like edit/create is performed   |
...
| destroy                  | Emitted when the annotated text component is destroyed.                                            |
